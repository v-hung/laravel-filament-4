        ...
        <div class="container">
            ...
            <div class="header-right header-dropdowns ml-0 ml-sm-auto w-sm-100">
                <div class="header-dropdown dropdown-expanded d-none d-lg-block">
                    ...
                    <div class="header-menu">
                        <ul>
                            ...
                            <li><a href="{{ route('blogs.show', ['blog_slug' => 'fashion']) }}">Blog</a></li>
                ...
                <div class="header-dropdown">
                    ...
                    <a href="#">
                        <i class="{{ $flags[$currentLocale] }} flag mr-2"></i>
                        {{ strtoupper($currentLocale) }}</a>
                    <div class="header-menu">
                        <ul>
                            <li><a href="{{ route('lang.switch', 'en') }}"><i class="flag-us flag mr-2"></i>ENG</a>
                            </li>
                            <li><a href="{{ route('lang.switch', 'vi') }}"><i class="flag-vn flag mr-2"></i>VIE</a></li>
                        </ul>
                    </div>
                    <!-- End .header-menu -->
                </div>
        ...
        <div class="container">
            ...
            <div class="header-right w-lg-max">
                ...
                <div class="header-contact d-none d-lg-flex pl-4 pr-4">
                    ...
                    <h6><span>Call us now</span><a href="tel:#" class="text-dark font1">+84 399 633 237</a></h6>
                </div>

                <a href="@auth {{ route('dashboard') }} @else {{ route('login') }} @endauth" class="header-icon"
                    title="@auth {{ __('Dashboard') }} @else {{ __('Login') }} @endauth"><i
        ...
        <div class="container">
            <nav class="main-nav w-100">
                <ul class="menu">
                    ...
                    <li>
                        <a href="{{ route('collections') }}">Categories</a>
